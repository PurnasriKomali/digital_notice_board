...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `flashnews`(flash) VALUES ('$flash')";

    if (mysqli_query($conn, $sql)) {
      $_SESSION['flash_success'] = "Flash news submitted successfully.";
...
<?php if (isset($_SESSION['flash_success'])): ?>
    <script>
        alert("<?php echo $_SESSION['flash_success']; ?>");
    </script>
    <?php unset($_SESSION['flash_success']); // Clear the session variable after displaying the message ?>
<?php endif ?>
