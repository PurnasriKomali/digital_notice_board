...
<div class="container mt-4">
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                // Retrieve data from birthday table
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="update_birthday.php">
                                <input type="hidden" name="birthday_id" value="<?php echo $row['reg_no']; ?>">
                                <input type="submit" name="update" value="Update">
                            </form>
                            <form method="post" action="delete_birthday.php">
                                <input type="hidden" name="birthday_id" value="<?php echo $row['reg_no']; ?>">
...
<?php if (isset($_SESSION['birthday_success'])): ?>
    <script>
        alert("<?php echo $_SESSION['birthday_success']; ?>");
    </script>
    <?php unset($_SESSION['birthday_success']); // Clear the session variable after displaying the message ?>
<?php endif ?>
